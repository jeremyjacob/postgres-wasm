export = v86;
export as namespace v86;

declare namespace v86 {
	...
	class BusConnector {
		 ...
		 */
		register(name: string, fn: Function, this_value: Object): any;
		 ...
		 * @param {function()} fn
		 */
		unregister(name: string, fn: Function): any;
		 ...
		 */
		send(name: string, value: any, unused_transfer?: any): any;
	}
	...
	class V86Starter {
		 ...
		 */
		save_state(
			callback: (error: Object | null, state: ArrayBuffer) => void
		): void;
		 ...
		 * @param data
		 */
		serial_send_bytes(serial: number, data: Uint8Array): any;
		...
		create_file(
			file: string,
			data: Uint8Array,
			callback?: (error: Object | null) => void
		): void;
		...
		read_file(file: string): BufferSource;
	}
}
